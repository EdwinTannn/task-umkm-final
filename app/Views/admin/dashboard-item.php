                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"><strong>Add Items</strong></h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <form method="post" action="/admin/dashboard/item/create/post" enctype="multipart/form-data">
                                                <?= csrf_field(); ?>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-12 col-md-4">
                                                        <strong><span>Nama UMKM</span></strong>
                                                        <br>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if (!empty($item['img'])): ?>
                                                                <a href="#" data-toggle="modal" data-target="#imgItem<?= $item['uuid'] ?>">Image</a>
                                                            <?php endif; ?>
                                                        </td>
                                                        <td><?= esc($item['stock']) ?></td>
                                                        <td>Rp. <?= esc($item['price']) ?></td>
                                                        <td><a href="#" data-toggle="modal" data-target="#descriptionItem<?= $item['uuid'] ?>">Description</a></td>
                                                        <td><?= esc($item['created_at']) ?></td>
                                                        <td>
                                                            <a class="btn btn-primary" data-toggle="modal" data-target="#editItem<?= $item['uuid'] ?>">Edit</a>
                                                            /
                                                            <a class="btn btn-danger" data-toggle="modal" data-target="#deleteItem<?= $item['uuid'] ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
...
<div class="modal fade" id="descriptionItem<?= $item['uuid'] ?>" tabindex="-1" role="dialog" aria-labelledby="descriptionItemModalLabel<?= $item['uuid'] ?>" aria-hidden="true">
...
<!-- Image Detail -->
<?php foreach ($getItem as $item): ?>
<div class="modal fade" id="imgItem<?= $item['uuid'] ?>" tabindex="-1" role="dialog" aria-labelledby="imgItemModalLabel<?= $item['uuid'] ?>" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-secondary">
...
<!-- Image Detail -->
<?php foreach ($getItem as $item): ?>
<div class="modal fade" id="editItem<?= $item['uuid'] ?>" tabindex="-1" role="dialog" aria-labelledby="editItemModalLabel<?= $item['uuid'] ?>" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-secondary">
            ...
            <div class="modal-body">
                <form method="post" action="/admin/dashboard/item/edit/post/<?= esc($item['uuid']) ?>" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <!-- umkm name -->
                    <div class="row mb-2">
                        <div class="col-12 col-md-4">
                        ...
                        <div class="col-12 col-md-8">
                            <input class="form-control" type="text" placeholder="<?= esc($item['umkm']) ?>" name="umkm">
                        </div>
                    </div>
                    <!-- / -->
...
<!-- Delete Item Modal -->
<?php foreach ($getItem as $item): ?>
<div class="modal fade" id="deleteItem<?= $item['uuid'] ?>" tabindex="-1" role="dialog" aria-labelledby="deleteItemLabel<?= $item['uuid'] ?>" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    ...
                    <br>
                    <strong><?= esc($item['name_item']) ?></strong> Created by <?= esc($item['umkm']) ?>?
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                <a href="/admin/dashboard/item/delete/<?= esc($item['uuid']) ?>" class="btn btn-danger">Delete</a>
            </div>
        </div>
    </div>
</div>
